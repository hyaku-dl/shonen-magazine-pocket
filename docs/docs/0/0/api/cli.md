...
`cao(group: <function group at 0x7f7e4d0e75b0>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7f7e4d0e75b0>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`

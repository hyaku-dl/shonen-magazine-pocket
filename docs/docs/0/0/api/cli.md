...
`cao(group: <function group at 0x7f2f45a6b5b0>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7f2f45a6b5b0>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`

...
`cao(group: <function group at 0x7fc5221775b0>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7fc5221775b0>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`

...
`cao(group: <function group at 0x7fa7b99c35b0>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7fa7b99c35b0>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`
